...
int main() {
    ...
    do {
        ...
        switch (tablas_multiplicacion) //mismo codigo del switch que el ejercicio 19
        {
        case 1:
            for (int i = 1; i <= 10; i++)  
            {
        ...
        case 10:
            ...
            break;
        default:
            cout << "Tabla no tabulada" << endl;
        }
        cout << "¿Desea calcular otra tabla? (s/n): ";
        cin >> respuesta;
    } while (respuesta == 's'); // Repite el proceso si la respuesta es 's'
    return 0;
}
